...
class HelloServiceClient implements \Test\Service\HelloServiceIf {
  ...
  {
    $args = new \Test\Service\HelloService_say_args();
    $args->msg = $msg;
  ...
  public function recv_say()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Test\Service\HelloService_say_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Test\Service\HelloService_say_result();
